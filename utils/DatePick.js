...
export default function DatePick() {
  ...
  return (
    <div className="h-48 w-screen flex items-center justify-center bg-[#EFF7F0] rounded-lg ">
      <div className="">
        <div>
          <div className="container mx-auto px-4 py-2 ">
            <div className="mb-28 w-64">
              <label htmlFor="datepicker" className=" mb-1  text-gray-700 ">
                Select Date
              </label>
